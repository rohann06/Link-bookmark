/*
  ...
  - The primary key for the `SavedLinks` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- DropForeignKey
ALTER TABLE "SavedLinks" DROP CONSTRAINT "SavedLinks_linkId_fkey";
...
-- AlterTable
ALTER TABLE "SavedLinks" DROP CONSTRAINT "SavedLinks_pkey",
ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "id" SET DATA TYPE TEXT,
ALTER COLUMN "userId" SET DATA TYPE TEXT,
ALTER COLUMN "linkId" SET DATA TYPE TEXT,
ADD CONSTRAINT "SavedLinks_pkey" PRIMARY KEY ("id");
DROP SEQUENCE "SavedLinks_id_seq";
